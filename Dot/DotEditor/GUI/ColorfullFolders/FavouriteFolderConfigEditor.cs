            ...
            rList.drawElementCallback = (rect, index, isActive, isFocused) =>
              {
                  ...
                  GUI.DrawTexture(previewRect, (Texture2D)largeIconProperty.objectReferenceValue ?? DEGUIResources.DefaultFolderIcon);

                  previewRect.y += previewRect.height - Styles.SMALL_ICON_SIZE;
                  previewRect.width = previewRect.height = Styles.SMALL_ICON_SIZE;
                  GUI.DrawTexture(previewRect, (Texture2D)smallIconProperty.objectReferenceValue ?? DEGUIResources.DefaultFolderIcon);
              };
