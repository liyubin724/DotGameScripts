...
using LogUtil = UnityEngine.Debug;
...
namespace Dot.Utilities
{
    public static class AssemblyUtility
    {
        ...
        public static Type GetGenericType(string genericTypeFullName,params string[] paramTypeFullNames)
        {
            ...
            {
                LogUtil.LogError("AssemblyUtil::GetGenericType->Arg is Null");
                return null;
            }
            ...
            if(genericType == null)
            {
                LogUtil.LogError($"AssemblyUtil::GetGenericType->Type Not Found.Type = {genericTypeFullName}");
                return null;
            }
            ...
            for(int i =0;i<paramTypeFullNames.Length;i++)
            {
                ...
                {
                    LogUtil.LogError("AssemblyUtil::GetGenericType->Param Type Is NUll");
                    return null;
                }
                Type t = GetTypeByFullName(paramTypeFullNames[i]);
                if(t == null)
                {
                    LogUtil.LogError($"AssemblyUtil::GetGenericType->Param Type Not Found.Type = {paramTypeFullNames[i]}");
                }
                types[i] = t;
            }
